...
import uk.co.ourfriendirony.medianotifier.pageradapter.ActivityArtistPagerAdapter;

public class ActivityArtistUnwatched extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new ActivityArtistPagerAdapter(getSupportFragmentManager());
