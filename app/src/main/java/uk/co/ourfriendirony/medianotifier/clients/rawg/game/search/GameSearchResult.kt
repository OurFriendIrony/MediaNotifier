...
@JsonPropertyOrder("slug", "name", "playtime", "platforms", "stores", "released", "tba", "background_image", "rating", "rating_top", "ratings", "ratings_count", "reviews_text_count", "added", "added_by_status", "metacritic", "suggestions_count", "id", "score", "clip", "tags", "user_game", "reviews_count", "saturated_color", "dominant_color", "short_screenshots", "parent_platforms", "genres")
